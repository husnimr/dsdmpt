      ...
      <div className="subpage-hero-wrapper">
        ...
        >
          ...
          <div className="subpage-hero-content">
            <h1 className="subpage-hero-title">Global Talent</h1>
          </div>
        </section>
      </div>
        ...
        <section style={{ padding: '2rem 0', backgroundColor: '#FFFFFF' }}>
          <div className="container" style={{ display: 'grid', gridTemplateColumns: '1.1fr 1.9fr', gap: '3.5rem', alignItems: 'center' }}>
            <div style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: 'var(--shadow-lg)', border: '1px solid #E2E8F0' }}>
              <img 
                src={getImageUrl('/uploads/global.jpg')} 
                alt="Universitas Indonesia Rectorate" 
                style={{ width: '100%', height: 'auto', display: 'block' }}
              />
            </div>
            <div>
              <p style={{ fontSize: '0.98rem', lineHeight: '1.8', color: '#2C3A47', marginBottom: '1.25rem' }}>
                <strong>Global Talent</strong> merupakan program Universitas Indonesia yang bertujuan untuk memperkuat kapasitas dan jejaring talenta akademik di tingkat internasional melalui kolaborasi, mobilitas, dan pengembangan kegiatan akademik serta riset. Program ini merupakan bagian dari upaya UI dalam meningkatkan kualitas sumber daya manusia, memperluas jejaring global, meningkatkan kualitas publikasi dan riset, serta memperkuat posisi UI sebagai universitas berkelas dunia.
              </p>
              <p style={{ fontSize: '0.98rem', lineHeight: '1.8', color: '#2C3A47', margin: 0 }}>
                Program Global Talent dapat melibatkan dosen, peneliti, mahasiswa pascadoktoral, dan mitra akademik dari institusi luar negeri. Bentuk kegiatannya antara lain kolaborasi riset internasional, postdoctoral researcher dari luar negeri, joint supervision, visiting professor, serta kegiatan mobilitas akademik lainnya sesuai dengan program yang tersedia di SDM dan Pengembangan Talenta sebagaimana tertuang dalam Rencana Strategis (Renstra) Universitas Indonesia tahun 2024-2029.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2.5rem', marginBottom: '2.5rem' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '1.5rem' }}>
                <div style={{ width: '60px', height: '60px', borderRadius: '50px', backgroundColor: '#ffffff', color: '#0A1E38', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'var(--shadow-md)', marginBottom: '1.25rem' }}>
                  <BookOpen size={24} />
                </div>
                <p style={{ fontSize: '0.88rem', lineHeight: '1.6', color: '#576574' }}>
        ...
        <section style={{ padding: '4rem 0', backgroundColor: '#FFFFFF' }}>
          <div className="container">
            ...
            <div style={{ position: 'relative', maxWidth: '850px', margin: '0 auto', padding: '1rem 0' }}>
              ...
              {/* Step 1 */}
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '2.5rem' }}>
                <div style={{ width: '45%', padding: '1.5rem', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #E2E8F0', boxShadow: 'var(--shadow-sm)', borderLeft: '4px solid #F2C94C' }}>
                  <h3 style={{ fontSize: '1.05rem', color: '#0A1E38', fontWeight: '700', marginBottom: '0.5rem' }}>1. Sosialisasi Program</h3>
                ...
                <div style={{ zIndex: 10, width: '32px', height: '32px', borderRadius: '50px', backgroundColor: '#0A1E38', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '0.85rem' }}>1</div>
                <div style={{ width: '45%' }} />
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '2.5rem' }}>
                <div style={{ width: '45%' }} />
                <div style={{ zIndex: 10, width: '32px', height: '32px', borderRadius: '50px', backgroundColor: '#0A1E38', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '0.85rem' }}>2</div>
                <div style={{ width: '45%', padding: '1.5rem', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #E2E8F0', boxShadow: 'var(--shadow-sm)', borderLeft: '4px solid #F2C94C' }}>
                  <h3 style={{ fontSize: '1.05rem', color: '#0A1E38', fontWeight: '700', marginBottom: '0.5rem' }}>2. Pengajuan atau Identifikasi</h3>
                  <p style={{ fontSize: '0.85rem', color: '#576574', lineHeight: '1.6', margin: 0 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '2.5rem' }}>
                <div style={{ width: '45%', padding: '1.5rem', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #E2E8F0', boxShadow: 'var(--shadow-sm)', borderLeft: '4px solid #F2C94C' }}>
                  <h3 style={{ fontSize: '1.05rem', color: '#0A1E38', fontWeight: '700', marginBottom: '0.5rem' }}>3. Verifikasi dan Seleksi</h3>
                  <p style={{ fontSize: '0.85rem', color: '#576574', lineHeight: '1.6', margin: 0 }}>
                    Pengajuan dan calon peserta diverifikasi berdasarkan persyaratan, relevansi kegiatan, kompetensi, serta kesesuaian dengan tujuan program.
                  </p>
                </div>
                <div style={{ zIndex: 10, width: '32px', height: '32px', borderRadius: '50px', backgroundColor: '#0A1E38', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '0.85rem' }}>3</div>
                <div style={{ width: '45%' }} />
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '2.5rem' }}>
                <div style={{ width: '45%' }} />
                <div style={{ zIndex: 10, width: '32px', height: '32px', borderRadius: '50px', backgroundColor: '#0A1E38', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '0.85rem' }}>4</div>
                <div style={{ width: '45%', padding: '1.5rem', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #E2E8F0', boxShadow: 'var(--shadow-sm)', borderLeft: '4px solid #F2C94C' }}>
                  <h3 style={{ fontSize: '1.05rem', color: '#0A1E38', fontWeight: '700', marginBottom: '0.5rem' }}>4. Penetapan</h3>
                  <p style={{ fontSize: '0.85rem', color: '#576574', lineHeight: '1.6', margin: 0 }}>
                    Peserta, penerima program, atau mitra yang memenuhi persyaratan dan lolos seleksi ditetapkan sesuai dengan ketentuan yang berlaku.
                  </p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '2.5rem' }}>
                <div style={{ width: '45%', padding: '1.5rem', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #E2E8F0', boxShadow: 'var(--shadow-sm)', borderLeft: '4px solid #F2C94C' }}>
                  <h3 style={{ fontSize: '1.05rem', color: '#0A1E38', fontWeight: '700', marginBottom: '0.5rem' }}>5. Pelaksanaan Kegiatan</h3>
                  <p style={{ fontSize: '0.85rem', color: '#576574', lineHeight: '1.6', margin: 0 }}>
                    Kegiatan dilaksanakan sesuai dengan rencana, durasi, peran, dan tanggung jawab yang telah ditetapkan.
                  </p>
                </div>
                <div style={{ zIndex: 10, width: '32px', height: '32px', borderRadius: '50px', backgroundColor: '#0A1E38', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '0.85rem' }}>5</div>
                <div style={{ width: '45%' }} />
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '2.5rem' }}>
                <div style={{ width: '45%' }} />
                <div style={{ zIndex: 10, width: '32px', height: '32px', borderRadius: '50px', backgroundColor: '#0A1E38', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '0.85rem' }}>6</div>
                <div style={{ width: '45%', padding: '1.5rem', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #E2E8F0', boxShadow: 'var(--shadow-sm)', borderLeft: '4px solid #F2C94C' }}>
                  <h3 style={{ fontSize: '1.05rem', color: '#0A1E38', fontWeight: '700', marginBottom: '0.5rem' }}>6. Monitoring dan Evaluasi</h3>
                  <p style={{ fontSize: '0.85rem', color: '#576574', lineHeight: '1.6', margin: 0 }}>
                    Pelaksanaan kegiatan dipantau dan dievaluasi untuk memastikan kesesuaian kegiatan dengan tujuan dan target yang telah ditetapkan.
                  </p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                <div style={{ width: '45%', padding: '1.5rem', backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #E2E8F0', boxShadow: 'var(--shadow-sm)', borderLeft: '4px solid #F2C94C' }}>
                  <h3 style={{ fontSize: '1.05rem', color: '#0A1E38', fontWeight: '700', marginBottom: '0.5rem' }}>7. Pelaporan</h3>
                  <p style={{ fontSize: '0.85rem', color: '#576574', lineHeight: '1.6', margin: 0 }}>
                    Peserta atau pelaksana menyampaikan laporan pelaksanaan dan luaran kegiatan sesuai dengan ketentuan yang berlaku.
                  </p>
                </div>
                <div style={{ zIndex: 10, width: '32px', height: '32px', borderRadius: '50px', backgroundColor: '#0A1E38', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '0.85rem' }}>7</div>
                <div style={{ width: '45%' }} />
              </div>
